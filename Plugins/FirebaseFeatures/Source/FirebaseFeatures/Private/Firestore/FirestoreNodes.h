...
public:
	...
	/**
	 * Converts the JSON to a field value.
	 **/
	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "Firebase|Firestore|FieldValue", meta = (CompactNodeTitle = "JSON", BlueprintAutocast))
	static FFirestoreFieldValue FieldValue_FromJSON(FString Value) { return FFirestoreFieldValue::FromJSON(Value); }

	/**
	 * Converts the field value to a JSON string.
	 **/
	UFUNCTION(BlueprintCallable, BlueprintPure, Category = "Firebase|Firestore|FieldValue", meta = (CompactNodeTitle = "JSON", BlueprintAutocast))
	static FString FieldValue_ToJSON(FFirestoreFieldValue Value) { return Value.ToJSON(); }
...
public:
	virtual void Activate();
	/**
	 * @brief Sets the document referenced by this DocumentReference.
	 *
