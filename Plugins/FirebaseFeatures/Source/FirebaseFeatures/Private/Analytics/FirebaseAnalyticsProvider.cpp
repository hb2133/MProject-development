...
{	
	UFirebaseAnalyticsLibrary::SetUserId(InUserID);
}
...
void FFirebaseAnalyticsProvider::SetDefaultEventAttributes(TArray<FAnalyticsEventAttribute>&& Attributes)
{

}

TArray<FAnalyticsEventAttribute> FFirebaseAnalyticsProvider::GetDefaultEventAttributesSafe() const
{
	return {};
}

int32 FFirebaseAnalyticsProvider::GetDefaultEventAttributeCount() const
{
	return 0;
}

FAnalyticsEventAttribute FFirebaseAnalyticsProvider::GetDefaultEventAttribute(int AttributeIndex) const
{
	return {};
}
